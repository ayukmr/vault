...
* trying to range query path from $a$ to $b$ can be split using [lca](../../gold/trees/least-common-ancestor), giving $a \rightarrow z$ and $b \rightarrow z$ as the ranges to find
